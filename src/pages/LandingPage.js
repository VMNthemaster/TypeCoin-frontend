  ...
  return (
    <div className={`min-h-[90vh] flex my-auto gap-x-[5vw] items-center justify-center`} style={backgroundImageClasses}>
      <div className={cardDivStyles}>
        <Card numOfSentences={numOfSentences} title='Typing Test' description='Improve your typing skills on your own' buttonText='Practice Yourself' colorObject={{title: 'text-blue-800', buttonColor: 'bg-blue-800'}} navigateTo='/single' />
      </div>
      <div className={cardDivStyles}>
        <Card numOfSentences={numOfSentences} title='Race your friends' description='Race with your friends and win ethereum' buttonText='Enter a typing race' colorObject={{title: 'text-blue-800', buttonColor: 'bg-orange-600'}} navigateTo='/username' />
      </div>
    </div>
  )
}
